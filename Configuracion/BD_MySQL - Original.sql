/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     15/06/2015 10:14:14 a.m.                   55*/
/*==============================================================*/
...
drop table if exists DNCTA;
drop table if exists DNESTRUCTURA_CTA;
drop table if exists DNDEPARTAMENTO;
drop table if exists DNDESCUENTOS;
...
drop table if exists DNPERSONALIZA_APP;
...
(
   CTA_EMPRESA          char(6),
   CTA_ID               int(11) not null auto_increment comment 'Campo de ID de la Tabla',
   CTA_DATTIM           timestamp default CURRENT_TIMESTAMP comment 'Campo de Fecha y Hora de Creacion del Registro',
   CTA_USER             char(10) comment 'Usuario que Ingreso el Registro',
   CTA_MACPC            char(20) comment 'Mac Address del Equipo que incluyo el Registro',
   CTA_PADRE            int(11)  null default null,
	CTA_NIVEL            int(11)  null default null,
   CTA_CODIGO           char(100) not null,
   CTA_NOMBRE           char(160),
   CTA_ACTIVO           bool,
   primary key (CTA_ID)
);

alter table DNCTA comment 'Tabla del Plan de Cuentas';
/*==============================================================*/
/* Index: DNCTA_INDEX_1                                         */
/*==============================================================*/
create unique index DNCTA_INDEX_1 on DNCTA
(
   CTA_CODIGO
);

/*==============================================================*/
/* Table: DNESTRUCTURA_CTA                                      */
/*==============================================================*/
create table DNESTRUCTURA_CTA
(
   STR_EMPRESA          char(6),
   STR_ID               int(11) not null auto_increment comment 'Campo de ID de la Tabla',
   STR_DATTIM           timestamp default CURRENT_TIMESTAMP comment 'Campo de Fecha y Hora de Creacion del Registro',
   STR_USER             char(10) comment 'Usuario que Ingreso el Registro',
   STR_MACPC            char(20) comment 'Mac Address del Equipo que incluyo el Registro',
   STR_PADRE            int(1)  null default null,
   STR_NIVEL_MAX        int(1)  null default null,
   STR_NIVEL_PREFIJO    int(1)  null default null,
   STR_PREFIJO          char(1),
   STR_LONG_PREF        int(1)  null default null,
   STR_ACTIVO           bool,
   primary key (STR_ID)
);

alter table DNESTRUCTURA_CTA comment 'Tabla de Configuracion de la Estructura de las Cuentas Contables';
/*==============================================================*/
/* Index: DNESTRUCTURA_CTA_INDEX_1                                         */
/*==============================================================*/
create unique index DNESTRUCTURA_CTA_INDEX_1 on DNESTRUCTURA_CTA
(
   STR_PADRE
);
...
/* Table: DNDESCUENTOS                                          */
/*==============================================================*/
create table DNDESCUENTOS
(
   DES_EMPRESA           char(6),
   DES_ID                int(11) NOT NULL AUTO_INCREMENT,
   DES_USER              char(10) NULL DEFAULT NULL,
   DES_MACPC             char(20) NULL DEFAULT NULL,
   DES_CODIGO            char(20) NULL DEFAULT NULL,
   DES_DESCRI            char(80) NULL DEFAULT NULL,
   DES_CODPRO            char(10) NULL DEFAULT NULL,
   DES_PORCEN            char(3) NULL DEFAULT NULL,
   DES_SUBTOTAL          TINYINT(1) NULL DEFAULT NULL,
   DES_FCHINI            date NULL DEFAULT NULL,
   DES_FCHFIN            date NULL DEFAULT NULL,
   DES_ACTIVO            tinyint(1) NULL DEFAULT NULL,
   DES_CANJEA            char(3) NULL DEFAULT NULL,
   DES_USOS              char(3) NULL DEFAULT NULL,
   primary key (`DES_ID`)
);

/*==============================================================*/
/* Index: FK_DNDESCUENTOS_DNEMPRESAS                            */
/*==============================================================*/
create index FK_DNDESCUENTOS_DNEMPRESAS on DNDESCUENTOS
(
   DES_EMPRESA
);

create index DES_CODIGO on DNDESCUENTOS
(
   DES_CODIGO
);

create index FK_DNDESCUENTOS_DNPRODUCTO on DNDESCUENTOS
(
   DES_CODPRO
);
...
/* Table: DNMARCA                                               */
/*==============================================================*/
create table DNMARCA
(
   MAR_EMPRESA          CHAR(6) NULL DEFAULT NULL,
   MAR_ID               INT(11) NOT NULL AUTO_INCREMENT,
   MAR_DATTIM           TIMESTAMP NULL DEFAULT NULL,
   MAR_USER             CHAR(10) NULL DEFAULT NULL,
   MAR_MACPC            CHAR(20) NULL DEFAULT NULL,
   MAR_CODIGO           CHAR(10) NOT NULL COMMENT 'Codigo de Marca',
   MAR_DESCRI           CHAR(60) NULL DEFAULT NULL COMMENT 'Descripcion de Marca',
   MAR_ACTIVO           TINYINT(1) NULL DEFAULT NULL,
   PRIMARY KEY (MAR_ID)
);
...
/* Index: MAR_CODIGO                                            */
/*==============================================================*/
create unique index MAR_CODIGO on DNMARCA
(
   MAR_CODIGO
);

create unique index FK_DNMARCA_DNEMPRESAS on DNMARCA
(
   MAR_EMPRESA
);
...
/*==============================================================*/
/* Table: DNPERSONALIZA_APP                                     */
/*==============================================================*/
create table DNPERSONALIZA_APP
(
   CONF_EMPRESA         char(6),
   CONF_COLOR_FORM      char(50),
   CONF_COLOR_TEXT      char(50)
);
...
(
   ...
   PRO_CODMAE           char(10),
   PRO_NOMBRE           char(80) comment 'Descripcion del Producto',
   PRO_DESCRI           text,
   PRO_TIPPREC          char(1),
   PRO_CODUND           char(1),
   PRO_UTILIZ           char(3) comment 'Utilizacion del Producto (Compra, Ventas, Servicio, etc)',
   PRO_TIPIVA           char(3),
   PRO_RUTAIMG          text comment 'Codigo de Relacion del Producto con el Sub-Grupo',
   PRO_ACTIVO           bool,
   primary key (PRO_ID)
);
...
alter table DNCTA add constraint FK_DNCTA_DNEMPRESAS foreign key (CTA_EMPRESA)
      references DNEMPRESAS (EMP_CODIGO) on delete restrict on update restrict;

alter table DNESTRUCTURA_CTA add constraint FK_DNESTRUCTURA_CTA_DNEMPRESAS foreign key (STR_EMPRESA)
      references DNEMPRESAS (EMP_CODIGO) on delete restrict on update restrict;
      
alter table DNDIRECCION add constraint FK_DNDIRECCION_DNEMPRESAS foreign key (DIR_EMPRESA)
      references DNEMPRESAS (EMP_CODIGO) on delete restrict on update restrict;

alter table DNDESCUENTOS add constraint FK_DNDESCUENTOS_DNEMPRESAS foreign key (DES_EMPRESA)
      references dnempresas (EMP_CODIGO) on delete restrict on update restrict;
...
alter table DNMARCA add constraint FK_DNMARCA_DNEMPRESAS foreign key (MAR_EMPRESA)
      references DNEMPRESAS (EMP_CODIGO) on delete restrict on update set null;
...
alter table DNPRODUCTO add constraint FK_DNPRODUCTOS_DNUNDMEDIDA foreign key (PRO_CODUND)
      references DNUNDMEDIDA (MED_CODIGO) on delete restrict on update restrict;

alter table DNPRODUCTO add constraint FK_DNPRODUCTO_DNEMPRESAS foreign key (PRO_EMPRESA)
      references DNEMPRESAS (EMP_CODIGO) on delete restrict on update restrict;

alter table DNPRODUCTO add constraint FK_DNPRODUCTO_DNLISTPRE foreign key (PRO_TIPPREC)
      references DNLISTPRE (LIS_CODIGO) on delete restrict on update restrict;

alter table DNPRODUCTO add constraint FK_DNPRODUCTO_DNMAESTRO foreign key (PRO_CODMAE)
