...
public class Usuarios extends javax.swing.JInternalFrame {
     ...
     */
    private TablaUsuarios mdlUsuario;
    public Usuarios(JDesktopPane mainApp) {
        initComponents();
        mdlUsuario = new TablaUsuarios();
    ...
    private void initComponents() {
        ...
        bntActualizarUsuario.setText("Modificar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       UsuarioNuevo pvc = new UsuarioNuevo();
    ...
    private void bntActualizarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntActualizarUsuarioActionPerformed
        ...
        if(indice != -1)
        {
            Usuario usuario = mdlUsuario.getUsuario(indice);
             UsuarioNuevo pvc = new UsuarioNuevo(usuario);
            JLabel aviso = pvc.getLabelEscondido();
    ...
    public void mostrarRegistrosEncontrados(DocumentEvent e)
    {
        try {
            ...
            TablaUsuarios mtu = new TablaUsuarios(nombreBuscar);
